...
handlers["366"] = function(o, prefix, me, channel, msg)
	if o.track_users then
		o:invoke("NameList", channel, o.channels[channel])
	end
end
	...
	if o.track_users and target ~= o.nick then
		...
		for c in modes:gmatch(".") do
			...
			elseif c == "o" then
				...
				if not o.channels[target].users[user] then print("* Ignoring bad error change for ", user); return; end
